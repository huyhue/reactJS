    ...
    return (
      <div className="_013">
        ...
        <div className="row pt-5">
         ...
         <Content tieude="Cach su dung props"  anh="img/01.jpg" vitri1="order-lg-2" trichdan="Day la trich dan so 1"/>
         <Content tieude="Tin tuc so 2 " anh="img/02.jpg"  trichdan="Day la trich dan so 2"/>
         <Content tieude="Tin tuc so 3" anh="img/03.jpg"  vitri1="order-lg-2" trichdan="One Page Wonder is an Bootstrap 4 starter theme for quickly crbsites in Bootstrap."/>
         
         <Content tieude="Cach su dung props  "  anh="img/01.jpg" trichdan="Day la trich dan so 1"/>
         <Content tieude="Tin tuc so 2 " anh="img/02.jpg"  trichdan="Day la trich dan so 2"/>
         <Content tieude="Tin so 3" anh="img/03.jpg"  trichdan="One Page Wonder is an Bootstrap 4 starter theme for quick one page websites in Bootstrap."/>
